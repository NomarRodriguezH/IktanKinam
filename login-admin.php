...
require_once "config.php";
   ...
   if(empty($correo_err) && empty($password_err)){
    ...
    $consulta="SELECT * FROM admin WHERE usuario = '$correo' AND pass = '$password' " ;
    ...
    if (!empty($fila [5]) || !empty($fila [8])  ){
          if($statusA == 1 ){
            session_start();
            $_SESSION["adminLOG"] = true;
            $_SESSION['adminID'] = $idA;
            $_SESSION['adminUser'] = $userA;
            $_SESSION['statusA'] = $statusA;
            header ('location: administrador/index.php');
            exit;
          }
          else{
      ...
      <div class="box--outer">
        <div class="box">
          <div class="box--inner">
            <div class="content">
              <div class="holder">
                <b>Bievenido al inicio de sesion del administrador</b> — ten cuidado si ingresas datos erroneos.
                <br>
                <br>
                ...
                <div class="row">
                  ...
                  <div class="col col__center">
                    <input type="text" id="login" name="correo" maxlength="32" value="" >
                  </div>
                </div>
