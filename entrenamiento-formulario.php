<?php
	...
	if($formEnviado == '1'){
		header('location: entrenador/panel');
	}
...
<html lang="en">
<head>
	<title>Blog Entrenamiento | IK</title>
...
<body>
	...
	<div class="row">
	<?php
	$sqlpg = "SELECT * FROM esp WHERE id_rol ='3' ";
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			$sqlauth = "SELECT * FROM `entrenador_datos` WHERE id_A = '$id' ";
	...
	<div class="col-md-4 mb-3">
			<div class="card">
				...
				<div class="card-body">
					...
					<a href="entrenamiento-datos.php?id=<?php echo $id ;?>" class="btn btn-primary">Escoger</a>
				</div>
		</div>		
	</div>
